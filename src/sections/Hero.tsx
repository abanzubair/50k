...
export default function Hero() {
  ...
  const heroImage = storefront?.hero_banner_url || '/images/hero-saree.jpg';
  const tagline = storefront?.tagline || 'Discover our curated collection of authentic Indian sarees — each piece a story woven in pure silk and artisanal heritage.';
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-[400px] sm:h-[500px] lg:absolute lg:right-0 lg:top-20 lg:h-[calc(100%-5rem)] lg:w-1/2 pointer-events-none mt-8 lg:mt-0 order-2 lg:order-none px-4 lg:px-0">
      ...
      <div className="relative z-10 text-left px-5 md:px-16 lg:pl-24 max-w-2xl w-full lg:w-1/2 order-1 lg:order-none">
        ...
        >
          {storeName.toUpperCase()} EXCLUSIVE COUTURE
        </p>
